...
export default function SoirScreen() {
  ...
  useEffect(() => {
    if (params.recipeId && params.openModal === 'true') {
      ...
      const recipe = soirRecipes.find(r => r.id === recipeId);
      
      console.log(`🎯 Recherche recette soir ID: ${recipeId}`);
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <MomentHeader
          ...
          icon={<Moon size={32} color={Colors.textLight} />}
        />
      </View>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchInputContainer}>
          ...
          <TextInput
            ...
            placeholder="Rechercher un dîner..."
      ...
      <View style={styles.content}>
        <FlatList
          data={showSearchResults ? filteredRecipes : soirRecipes}
